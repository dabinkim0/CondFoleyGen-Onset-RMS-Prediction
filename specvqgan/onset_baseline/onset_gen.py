...
if __name__ == '__main__': 
    ...
    # resume = 'checkpoints/EXP_100_epoch_without_pretrained/checkpoint_ep30.pth.tar'
    resume = '/home/dabin/video2sound/CondFoleyGen/specvqgan/onset_baseline/checkpoints/EXP_100_epoch_without_pretrained/checkpoint_ep30.pth.tar'
    net, _ = torch_utils.load_model(resume, net, device=device, strict=True)
    read_folder = '/home/dabin/video2sound/CondFoleyGen/specvqgan/onset_baseline/inference_gen' 
    # name to a directory that generated with `audio_generation.py` 
    original_video_list = glob.glob(f'{read_folder}/2sec_full_orig_video/*.mp4')        # 해당 파일 없음
