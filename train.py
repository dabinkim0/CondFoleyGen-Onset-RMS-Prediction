...
#     non_defaults = {k: v for k, v in vars(opt).items() if getattr(default_args, k, None) != v}
#     return sorted(non_defaults.keys())
...
if __name__ == '__main__':
    ...
    try:
        ...
        # logger_cfg = lightning_config.logger or OmegaConf.create()    # error      
        ...
        # modelckpt_cfg = lightning_config.modelcheckpoint or OmegaConf.create()    # error
        ...
        if not cpu:
            # print('trainer.gpus: ', lightning_config.trainer.gpus)
